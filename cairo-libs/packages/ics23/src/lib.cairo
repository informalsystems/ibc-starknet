...
pub use types::{
    ...
    InnerSpec, KeyBytes, LeafOp, LengthOp, NonExistenceProof, NonExistenceProofImpl, Proof,
    ProofSpec, ProofSpecImpl, ProofSpecTrait, RootBytes, ValueBytes,
};
pub use utils::{
    ...
    byte_array_to_slice_u32, decode_hex, encode_hex, u64_into_array_u32,
};
