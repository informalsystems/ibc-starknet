...
use hermes_cairo_encoding_components::types::nat::Z;
...
where
    ...
    SumEncoders<Z, HList![EncodeWithContext, EncodeWithContext]>:
        for<'a> MutEncoder<Encoding, Strategy, Sum![Felt, &'a String]>,
{
    fn encode_mut(
        encoding: &Encoding,
        value: &Denom,
        ...
        <SumEncoders<Z, HList![EncodeWithContext, EncodeWithContext]>>::encode_mut(
            encoding, &sum, buffer,
        )?;
