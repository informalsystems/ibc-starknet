use hermes_chain_components::traits::packet::fields::{PacketDstChannelIdGetter, PacketTimeoutHeightGetter};
...
impl<Chain, Counterparty> PacketDstChannelIdGetter<Chain, Counterparty> for ReadPacketDstStarknetFields
where
...
impl<Chain, Counterparty> PacketTimeoutHeightGetter<Chain, Counterparty> for ReadPacketDstStarknetFields
where
    Chain: HasOutgoingPacketType<Counterparty, OutgoingPacket = Packet>,
