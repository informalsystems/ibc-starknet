        ...
        + HasEncodedType<Encoded = Vec<Felt>>,
{
    async fn upgrade_client_payload(
        chain: &Chain,
        upgrade_height: &u64,
    ) -> Result<StarknetUpgradeClientPayload, Chain::Error> {
        ...
        Ok(StarknetUpgradeClientPayload {
            ...
            upgrade_client_state: starknet_client_state,
            upgrade_consensus_state: starknet_consensus_state,
            upgrade_client_state_proof: client_state_proof,
            upgrade_consensus_state_proof: consensus_state_proof,
        })
    }
}
