        ...
        let starknet_ics20_send_message = {
            ...
            MsgTransfer {
                ...
                timeout_timestamp_on_b: Timestamp::from_nanoseconds(
                    u64::try_from((current_starknet_time.unix_timestamp() + 90) * 1_000_000_000)
                        .unwrap(),
                ),
            }
        };
...
#[test]
fn test_relay_timeout_packet_no_sleep() -> Result<(), Error> {
    // ### SETUP START ###
    let runtime = init_test_runtime();
    ...
    runtime.runtime.clone().block_on(async move {
        ...
        info!("will relay timeout packets without sleeping");
        ...
        let eventual_cosmos_amount = &Amount::new(
            balance_cosmos_a_step_0.quantity - transfer_quantity + transfer_back_quantity,
            denom_cosmos.clone(),
        );
