...
let
  light-client-cw = nixpkgs.rustPlatform.buildRustPackage {
    ...
    cargoLock = {
      ...
      outputHashes = {
        "cgp-0.4.0" = "sha256-I3LGUI8pJuKnDEEM6B7UCHdkQJjINdJB7P98Mkh5Ek8=";
        "hermes-cosmos-encoding-components-0.1.0" = "sha256-daHVJqP+DNy7siVJCBjG/zkxRPlApF054zXhwjdxc68=";
